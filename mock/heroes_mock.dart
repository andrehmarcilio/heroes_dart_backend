final heroesMock = [
  {
    ...
    'function': 'Lutador',
    'region': 'Runeterra',
    'firstable_phrase': 'Minha missão é destruir até a esperança',
    'lore':
    ...
    'image_string': 'https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Aatrox_0.jpg',
  },
  {
    'name': 'Kayn',
    'function': 'Assassino',
    'region': 'Ionia',
    'firstable_phrase': 'A criança se foi, mas o assassino vive.',
    'lore':
    ...
    'image_string': 'https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Kayn_0.jpg',
  },
  {
    'name': 'Master Yi',
    'function': 'Espadachin',
    'region': 'Ionia',
    'firstable_phrase': 'O gume da espada mais afiada não é páreo para a calmaria de uma mente em paz',
    'lore':
  ...
  },
  {
    ...
    'function': 'Atirador',
    'region': 'Ionia',
    'firstable_phrase': 'A arte requer uma certa... crueldade',
    'lore':
    ...
    'image_string': 'https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Jhin_0.jpg',
  },
  {
    'name': 'Ahri',
    'function': 'Mago',
    'region': 'Ionia',
    'firstable_phrase': 'As emoções humanas podem ser mais voláteis até do que a magia mais poderosa',
    'lore':
        'Aligação de Ahri com a magia do mundo espiritual é inata. Ela é uma vastaya com traços de raposa, capaz de manipular as emoções de sua presa e consumir sua essência, devorando também as memórias e as percepções de cada alma absorvida. Outrora uma predadora poderosa, porém rebelde, Ahri agora viaja pelo mundo em busca de vestígios dos seus antepassados enquanto tenta substituir as memórias roubadas por novas de sua própria autoria.',
    'image_string': 'https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Ahri_0.jpg',
  },
  {
    'name': 'Akali',
    'function': 'Assassina',
    'region': 'Ionia',
    'firstable_phrase': 'Ter cara de perigoso e ser perigoso são coisas diferentes',
    'lore':
    ...
    'image_string': 'https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Akali_0.jpg',
  },
  {
    'name': 'Bardo',
    'function': 'Suporte',
    'region': 'Runeterra',
    'firstable_phrase': 'O tilintar de seus passos são os ecos da mudança',
    'lore':
    ...
    'image_string': 'https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Bard_0.jpg',
  },
  {
    'name': 'Chogath',
    'function': 'Tanque',
    'region': 'O vazio',
    'firstable_phrase': 'Sua alma alimentará o Vazio!',
    'lore':
        'Apartir do momento em que Cho’Gath emergiu da terra para a luz do sol ofuscante de Runeterra, a besta foi motivada por pura fome insaciável. A mais perfeita expressão do desejo do Vazio de consumir toda a vida, a biologia complexa de Cho’Gath rapidamente converte matéria em crescimento corporal novo, aumentando sua massa e densidade muscular ou endurecendo sua carapaça externa como um diamante orgânico. Quando crescer não supre as necessidades dessa criatura do Vazio, ele vomita o material em excesso como espinhos afiados, deixando sua presa espetada e pronta para ser devorada mais tarde',
    'image_string': 'https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Chogath_0.jpg',
  },
  {
    'name': 'Cassiopéia',
    'function': 'Mago',
    'region': 'Noxus',
    'firstable_phrase': 'Segredos cortam mais do que lâminas…',
    'lore':
        'Cassiopeia é uma criatura mortífera que costuma manipular e submeter os outros às suas vontades. A filha caçula e mais bela da nobre família noxiana Du Couteau, ela se aventurou pelas criptas subterrâneas de Shurima em busca de um poder ancestral. Lá, Cassiopeia foi mordida por um dos terríveis guardiões da tumba, cujo veneno a transformou em uma víbora predadora. Ágil e astuta, hoje Cassiopeia desliza sob o véu da noite, petrificando seus inimigos com um olhar nefasto',
    'image_string': 'https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Cassiopeia_0.jpg',
  },
  {
    'name': 'Darius',
    'function': 'Lutador',
    'region': 'Noxus',
    'firstable_phrase': 'A História só lembra dos vitoriosos. Fique com Noxus e jamais seja esquecido',
    'lore':
        'Não há símbolo maior do poder de Noxus do que Darius, o mais temido e experiente líder da nação. Vindo de origens humildes para se tornar a Mão de Noxus, ele corta seu caminho através dos inimigos do império; muitos dos quais são, inclusive, noxianos. Sabendo que ele nunca duvida da integridade de sua causa, e que nunca hesita assim que seu machado é levantado, aqueles que desafiam o comandante da Legião Trifária não esperam por misericórdia',
    'image_string': 'https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Darius_0.jpg',
  },
  {
    'name': 'Draven',
    'function': 'Atirador',
    'region': 'Noxus',
    'firstable_phrase': "O melhor' é onde eu decido colocar os limites de cada dia",
    'lore':
        'Em Noxus, guerreiros conhecidos como calculistas lutam um contra o outro em uma arena onde sangue é derramado e a força é testada, mas nenhum foi tão celebrado como Draven. Um antigo soldado, ele descobriu que as multidões apreciavam seu instinto pelo drama, sem mencionar os jatos de sangue vindos de seus machados giratórios. Viciado no espetáculo de sua própria perfeição impetuosa, Draven jurou derrotar qualquer que seja seu oponente para garantir que seu nome será cantado pelo império para todo o sempre',
    'image_string': 'https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Draven_0.jpg',
  },
  {
    'name': 'Ezreal',
    'function': 'Atirador',
    'region': 'Piltover',
    'firstable_phrase': 'Se eu não conheço as regras, como posso estar desobedecendo?',
    'lore':
    ...
    'image_string': 'https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Ezreal_0.jpg',
  },
  {
    'name': 'Ekko',
    'function': 'Assassino',
    'region': 'Zaun',
    'firstable_phrase':
        'Meus dispositivos funcionam melhor quando não funcionam do jeito previsto... que é basicamente o tempo todo',
    'lore':
    ...
    'image_string': 'https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Ekko_0.jpg',
  },
  {
    'name': 'Fizz',
    'function': 'Assassino',
    'region': 'Runeterra',
    'firstable_phrase': 'Vocês não podem nem respirar na água. Que chatos',
    'lore':
    ...
    'image_string': 'https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Fizz_0.jpg',
  },
  {
    'name': 'Galio',
    'function': 'Tanque',
    'region': 'Demacia',
    'firstable_phrase': 'Fique atrás de mim, demaciano! Você pode não ter percebido, mas sou bem grande',
    'lore':
    ...
    'image_string': 'https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Galio_0.jpg',
  },
  {
    'name': 'Jax',
    'function': 'Lutador',
    'region': 'Runeterra',
    'firstable_phrase': 'Armas são feitas de força e vontade',
    'lore':
        'Maior mestre de armas de Runeterra, Jax é o último dos Kohari — campeões que juraram defender Icathia. Mas, quando o Vazio foi usado contra o Batalhão dos Ascendentes do império shurimane, Icathia foi destruída, deixando Jax sem um lar e sem um sentido para sua vida. Ele recolheu a última chama de Icathia, um símbolo da esperança de um dia derrotar o Vazio, e agora viaja pelo mundo em busca de guerreiros fortes o bastante para permanecer ao seu lado e enfrentar essa ameaça sombria e iminente',
    'image_string': 'https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Jax_0.jpg',
  },
  {
    'name': 'Kayle',
    'function': 'Lutador',
    'region': 'Demacia',
    'firstable_phrase': 'Nenhum humano é perfeito. Mas eu não sou humana.',
    'lore':
        'Nascida de um Aspecto targonense no auge das Guerras Rúnicas, Kayle honrava o legado de sua mãe lutando por justiça com asas de chamas divinas. Ela e sua irmã gêmea, Morgana, foram as protetoras de Demacia por muitos anos, até Kayle se desiludir com as repetidas falhas dos mortais e abandonar de vez o plano mortal. Mesmo assim, reza a lenda que ela continua punindo malfeitores com suas espadas de fogo e muitos esperam que um dia ela retorne…',
    'image_string': 'https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Kayle_0.jpg',
  },
  {
    'name': 'MordeKaiser',
    'function': 'Lutador',
    'region': 'Noxus',
    'firstable_phrase': 'Destino. Dominação. Desonra.',
    'lore':
        'Após morrer duas vezes e ressuscitar em mesmo número, Mordekaiser é um cruel comandante de uma época perdida. Ele usa a arte da necromancia para aprisionar almas e torná-las submissas pela eternidade. Hoje em dia, poucos se lembram das primeiras conquistas ou conhecem a real dimensão do poder de Mordekaiser. Porém, algumas almas ancestrais ainda se lembram, e temem que um dia ele volte para reivindicar seu domínio... tanto sobre os mortos quanto sobre os vivos',
    'image_string': 'https://www.leagueoflegends.com/pt-br/champions/mordekaiser/',
  },
  {
    'name': 'Nunu e Willump',
    'function': 'Tanque',
    'region': 'Freljord',
    'firstable_phrase':
        'Tire o pelo dos ouvidos, Willump! Porque essa vai ser a melhor história de todas as melhores histórias!',
    'lore':
    ...
    'image_string': 'https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Nunu_0.jpg',
  },
  {
    'name': 'Nilah',
    'function': 'Atirador',
    'region': 'Águas de Sentina',
    'firstable_phrase': 'Alegria em vida, alegria na eternidade.',
    'lore':
    ...
    'image_string': 'https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Nilah_0.jpg',
  },
  {
    'name': 'Pantheon',
    'function': 'Lutador',
    'region': 'Targon',
    'firstable_phrase': 'Aqui será minha eternidade... um dia que os deuses nunca se esquecerão!',
    'lore':
    ...
    'image_string': 'https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Pantheon_0.jpg',
  },
  {
    'name': 'Rengar',
    'function': 'Assassino',
    'region': 'Ixtal',
    'firstable_phrase': 'Cace os fracos e você sobreviverá. Cace os fortes e você terá uma vida.',
    'lore':
        'Rengar é um feroz caçador de troféus vastaya que gosta da emoção proporcionada pela caça e pelo abate de criaturas perigosas. Ele vasculha o mundo em busca das feras mais perigosas que pode encontrar, procurando principalmente por Kha’Zix, a criatura do vazio que arrancou seu olho. Rengar não persegue suas presas por fome nem por glória, mas pela simples beleza da caçada.',
    'image_string': 'https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Rengar_0.jpg',
  },
  {
    'name': 'Rell',
    'function': 'Suporte',
    'region': 'Noxus',
    'firstable_phrase': 'Seu coração tem que ser forte e duro como aço. Indestrutível.',
    'lore':
    ...
    'image_string': 'https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Rell_0.jpg',
  },
  {
    'name': 'Senna',
    'function': 'Atirador',
    'region': 'Runeterra',
    'firstable_phrase': 'Enquanto as sombras abraçam a luz, eu as abraço...',
    'lore':
    ...
    'image_string': 'https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Senna_0.jpg',
  },
  {
    'name': 'Sylas',
    'function': 'Mago',
    'region': 'Demacia',
    'firstable_phrase': 'Não sou um traidor. Sou a verdadeira Demacia.',
    'lore':
        'Criado em um dos bairros mais pobres de Demacia, Sylas de Dregbourne se tornou o símbolo do lado mais sombrio da Grande Cidade. Quando criança, sua habilidade de identificar magia chamou a atenção de importantes caçadores de magos, que depois o aprisionaram por ter se virado contra eles. Finalmente livre, agora Sylas vive como um revolucionário, usando a magia das pessoas ao seu redor para destruir o reino ao qual servia… e o grupo de magos exilados que o segue continua a crescer',
    'image_string': 'https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Sylas_0.jpg',
  },
  {
    'name': 'Talon',
    'function': 'Assassino',
